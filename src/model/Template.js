...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DocumentSignerTemplateConf', 'model/DocumentTeam', 'model/User'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DocumentSignerTemplateConf'), require('./DocumentTeam'), require('./User'));
  } else {
    // Browser globals (root is window)
    if (!root.SignrequestClient) {
      root.SignrequestClient = {};
    }
    root.SignrequestClient.Template = factory(root.SignrequestClient.ApiClient, root.SignrequestClient.DocumentSignerTemplateConf, root.SignrequestClient.DocumentTeam, root.SignrequestClient.User);
  }
}(this, function(ApiClient, DocumentSignerTemplateConf, DocumentTeam, User) {
  'use strict';
