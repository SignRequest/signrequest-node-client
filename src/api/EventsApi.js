...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} opts.documentSignrequestWho 
     * @param {String} opts.documentSignrequestFromEmail 
     * @param {String} opts.documentStatus 
     * @param {String} opts.documentUserEmail 
     * @param {String} opts.documentUserFirstName 
     * @param {String} opts.documentUserLastName 
     * @param {String} opts.delivered 
     * @param {String} opts.deliveredOn 
    ...
    this.eventsList = function(opts, callback) {
      ...
      var queryParams = {
        ...
        'document__signrequest__who': opts['documentSignrequestWho'],
        'document__signrequest__from_email': opts['documentSignrequestFromEmail'],
        'document__status': opts['documentStatus'],
        'document__user__email': opts['documentUserEmail'],
        'document__user__first_name': opts['documentUserFirstName'],
        'document__user__last_name': opts['documentUserLastName'],
        'delivered': opts['delivered'],
        'delivered_on': opts['deliveredOn'],
