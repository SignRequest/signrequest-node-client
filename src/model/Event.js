...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Document', 'model/DocumentTeam', 'model/Signer'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Document'), require('./DocumentTeam'), require('./Signer'));
  } else {
    // Browser globals (root is window)
    if (!root.SignrequestClient) {
      root.SignrequestClient = {};
    }
    root.SignrequestClient.Event = factory(root.SignrequestClient.ApiClient, root.SignrequestClient.Document, root.SignrequestClient.DocumentTeam, root.SignrequestClient.Signer);
  }
}(this, function(ApiClient, Document, DocumentTeam, Signer) {
  'use strict';
