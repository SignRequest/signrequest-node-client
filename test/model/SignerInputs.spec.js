...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SignrequestClient.SignerInputs();
  });
  ...
  describe('SignerInputs', function() {
    it('should create an instance of SignerInputs', function() {
      // uncomment below and update the code to test SignerInputs
      //var instance = new SignrequestClient.SignerInputs();
      //expect(instance).to.be.a(SignrequestClient.SignerInputs);
    });
    ...
    it('should have the property placeholder_uuid (base name: "placeholder_uuid")', function() {
      // uncomment below and update the code to test the property placeholder_uuid
      //var instance = new SignrequestClient.SignerInputs();
      //expect(instance).to.be();
    });
