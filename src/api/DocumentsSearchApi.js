...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} opts.signerEmails Email needed to sign/approve
     ...
     * @param {Number} opts.signerData Set to &#x60;1&#x60; to export with each signer on a separate row
    ...
    this.documentsSearchList = function(opts, callback) {
      ...
      var queryParams = {
        ...
        'signer_emails': opts['signerEmails'],
        'status': opts['status'],
        'who': opts['who'],
        'format': opts['format'],
        'signer_data': opts['signerData'],
      };
