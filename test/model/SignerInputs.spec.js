...
(function(root, factory) {
  ...
  describe('SignerInputs', function() {
    it('should create an instance of SignerInputs', function() {
      ...
      //var instane = new SignrequestClient.SignerInputs();
    ...
    it('should have the property placeholderUuid (base name: "placeholder_uuid")', function() {
      // uncomment below and update the code to test the property placeholderUuid
      //var instane = new SignrequestClient.SignerInputs();
      //expect(instance).to.be();
    });
