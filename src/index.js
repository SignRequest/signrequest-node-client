...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AuthToken', 'model/Document', 'model/DocumentAttachment', 'model/DocumentSearch', 'model/DocumentSignerTemplateConf', 'model/DocumentSigningLog', 'model/DocumentSignrequest', 'model/DocumentTeam', 'model/Event', 'model/FileFromSf', 'model/InlineDocumentSignerIntegrationData', 'model/InlineIntegrationData', 'model/InlinePrefillTags', 'model/InlineResponse200', 'model/InlineResponse2001', 'model/InlineResponse2002', 'model/InlineResponse2003', 'model/InlineResponse2004', 'model/InlineResponse2005', 'model/InlineResponse2006', 'model/InlineResponse2007', 'model/InlineResponse2008', 'model/InlineResponse2009', 'model/InlineResponse201', 'model/InlineResponse2011', 'model/InlineSignRequest', 'model/InlineTeam', 'model/InlineTeamMember', 'model/InviteMember', 'model/Placeholder', 'model/RequiredAttachment', 'model/SignRequest', 'model/SignRequestQuickCreate', 'model/Signer', 'model/SignerAttachment', 'model/SignerInputs', 'model/SigningLog', 'model/Team', 'model/TeamMember', 'model/Template', 'model/User', 'model/WebhookSubscription', 'api/ApiTokensApi', 'api/DocumentAttachmentsApi', 'api/DocumentsApi', 'api/DocumentsSearchApi', 'api/EventsApi', 'api/SignrequestQuickCreateApi', 'api/SignrequestsApi', 'api/TeamMembersApi', 'api/TeamsApi', 'api/TemplatesApi', 'api/WebhooksApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/AuthToken'), require('./model/Document'), require('./model/DocumentAttachment'), require('./model/DocumentSearch'), require('./model/DocumentSignerTemplateConf'), require('./model/DocumentSigningLog'), require('./model/DocumentSignrequest'), require('./model/DocumentTeam'), require('./model/Event'), require('./model/FileFromSf'), require('./model/InlineDocumentSignerIntegrationData'), require('./model/InlineIntegrationData'), require('./model/InlinePrefillTags'), require('./model/InlineResponse200'), require('./model/InlineResponse2001'), require('./model/InlineResponse2002'), require('./model/InlineResponse2003'), require('./model/InlineResponse2004'), require('./model/InlineResponse2005'), require('./model/InlineResponse2006'), require('./model/InlineResponse2007'), require('./model/InlineResponse2008'), require('./model/InlineResponse2009'), require('./model/InlineResponse201'), require('./model/InlineResponse2011'), require('./model/InlineSignRequest'), require('./model/InlineTeam'), require('./model/InlineTeamMember'), require('./model/InviteMember'), require('./model/Placeholder'), require('./model/RequiredAttachment'), require('./model/SignRequest'), require('./model/SignRequestQuickCreate'), require('./model/Signer'), require('./model/SignerAttachment'), require('./model/SignerInputs'), require('./model/SigningLog'), require('./model/Team'), require('./model/TeamMember'), require('./model/Template'), require('./model/User'), require('./model/WebhookSubscription'), require('./api/ApiTokensApi'), require('./api/DocumentAttachmentsApi'), require('./api/DocumentsApi'), require('./api/DocumentsSearchApi'), require('./api/EventsApi'), require('./api/SignrequestQuickCreateApi'), require('./api/SignrequestsApi'), require('./api/TeamMembersApi'), require('./api/TeamsApi'), require('./api/TemplatesApi'), require('./api/WebhooksApi'));
  }
}(function(ApiClient, AuthToken, Document, DocumentAttachment, DocumentSearch, DocumentSignerTemplateConf, DocumentSigningLog, DocumentSignrequest, DocumentTeam, Event, FileFromSf, InlineDocumentSignerIntegrationData, InlineIntegrationData, InlinePrefillTags, InlineResponse200, InlineResponse2001, InlineResponse2002, InlineResponse2003, InlineResponse2004, InlineResponse2005, InlineResponse2006, InlineResponse2007, InlineResponse2008, InlineResponse2009, InlineResponse201, InlineResponse2011, InlineSignRequest, InlineTeam, InlineTeamMember, InviteMember, Placeholder, RequiredAttachment, SignRequest, SignRequestQuickCreate, Signer, SignerAttachment, SignerInputs, SigningLog, Team, TeamMember, Template, User, WebhookSubscription, ApiTokensApi, DocumentAttachmentsApi, DocumentsApi, DocumentsSearchApi, EventsApi, SignrequestQuickCreateApi, SignrequestsApi, TeamMembersApi, TeamsApi, TemplatesApi, WebhooksApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The DocumentSigningLog model constructor.
     * @property {module:model/DocumentSigningLog}
     */
    DocumentSigningLog: DocumentSigningLog,
    /**
     * The DocumentSignrequest model constructor.
     * @property {module:model/DocumentSignrequest}
     */
    DocumentSignrequest: DocumentSignrequest,
    /**
     * The DocumentTeam model constructor.
     * @property {module:model/DocumentTeam}
     */
